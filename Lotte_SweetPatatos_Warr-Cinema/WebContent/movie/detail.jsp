        ...
        <main>
            <table align="center">
                ...
                <tr>
                    ...
                    <td class="title"><%=movie.getTitle()%>
                    </td>
                </tr>
                <tr>
                    <td><span class="color">예매율: </span><%=movie.getPercent()%>%
                        <span class="color">평점: </span><%=movie.getGrade()%>%
                    </td>
                </tr>
                <tr>
                    <td><span class="color">감독: </span><%=movie.getDirector()%>
                    </td>
                </tr>
                <tr>
                    <td><span class="color">장르: </span><%=movie.getGenre()%>
                    </td>
                </tr>
                <tr>
